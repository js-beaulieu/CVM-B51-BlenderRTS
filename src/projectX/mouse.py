...
class Mouse(object):
    ...
    def left_click(self, scene, mouse_pos):
        ...
        if logic.mouse.events[logic.KX_MOUSE_BUT_LEFT] == logic.KX_INPUT_JUST_ACTIVATED:
            ...
            self.x1 = mouse_pos.hitPosition[0]    # enregistre les coordonees initiales
            self.y1 = mouse_pos.hitPosition[1]

        if logic.mouse.events[logic.KX_MOUSE_BUT_LEFT] == logic.KX_INPUT_ACTIVE:
            self.x2 = mouse_pos.hitPosition[0]    # enregistre la position actuelle de la souris
